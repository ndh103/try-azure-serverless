...
function MainLayout({ children }: PropsWithChildren): JSX.Element {
  ...
  return (
    <div>
      <div className="h-12 w-full bg-teal-400 fixed p-3 flex">
      ...
      <div className="flex pt-12">
        ...
        <div
          className={`fixed top-0 left-0 h-screen w-screen bg-gray-300 z-10 opacity-60 ${isDrawerOpen ? 'block' : 'hidden'}`}
